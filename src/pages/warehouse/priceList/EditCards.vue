<template>
  <div
    ...
    id="page-priceListsDetails"
    role="tabpanel"
    aria-labelledby="priceListsDetails-tab"
  >
              ...
              >
                <table class="datatable-table table table-bordered mb-0">
                  ...
                  <tbody class="datatable-body">
                    <tr
                      v-for="(card, index) in formData.priceListsDetail"
                      :key="card.id"
                    ...
                    >
                      ...
                      <td class="datatable-cell">
                        <input
                          ...
                          v-model="formData.priceListsDetail[index].price"
                          :name="`priceListsDetail[${index}][price]`"
                        />
                      </td>
                      ...
                      <!-- <td class="datatable-cell">
                       ...
                       <td class="datatable-cell">
                        <div class>
                          <select class="form-control"  v-model="formData.priceListsDetail[index].product_id" :name="`priceListsDetail[${index}][product_id]`">
                            <option
                      ...
                      <td class="datatable-cell">
                        <div class>
                          <select class="form-control"  v-model="formData.priceListsDetail[index].unit_id" :name="`priceListsDetail[${index}][unit_id]`">
                            <optgroup v-for="product in products" :key="product.id" >
                               <option  v-for="unit in product.units"  :key="unit.id" :value="unit.unit_id" :selected="product.id == product.units.product_id">
                                 {{ unit.convert_rate}}
                               </option>
                          </optgroup>
                          </select>
...
export default {
  ...
  methods: {
    ...
    deleteRow(index) {
      this.formData.priceListsDetail.splice(index, 1);
      this.incrment--;
