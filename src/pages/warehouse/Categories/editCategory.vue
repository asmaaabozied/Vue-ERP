  ...
  <div>
    ...
    >
      ...
      <div class="card-header flex-wrap border-0 pb-0 d-block">
        <form @submit.prevent="updateCategory" id="currentForm" autocomplete="off">
            ...
            <div class="row">
              ...
              >
                <div class="form-group has-float-label">
                  ...
                  :selected="formData.id == $v.formData.$model.parent_id">
                    <option value=""></option>
              ...
              >
                <div class="form-group has-float-label">
                  ...
                  :selected="formData.unit_id == $v.formData.$model.unit_id">
                    <option value=""></option>
              ...
              >
                <div class="form-group has-float-label">
                  ...
                  :selected="formData.cost_way == $v.formData.$model.cost_way">
                    <option value=""></option>
              ...
              <div class="col-6">
                <div class="form-group has-float-label m-0">
                  <select class="form-control" name="product_type_id" 
                    ...
                    :selected="formData.product_type == $v.formData.$model.product_type">
                    <option value=""></option>
            ...
            <div class="row">
              ...
              >
                <fieldset class="p-2">
                  ...
                  <div class="d-flex">
                    <div class="col p-0">
                      <label class="checkbox checkbox-outline checkbox-outline-2x">
                        <input type="checkbox" name="apply_taxes" v-model="$v.formData.$model.taxable" :value="1"/>
                    ...
                    <div class="col p-0">
                      <div class="form-group has-float-label">
                        <select class="form-control" name="apply_tax_id" :disabled="$v.formData.$model.taxable == 0"
                          ...
                          :selected="formData.apply_tax == $v.formData.$model.apply_tax">
                          <option value=""></option>
                    ...
                    <div class="col-6">
                      <div class="form-group has-float-label">
                        <select class="form-control" name="purchase_disc_type_id" id="purchase_disc_type"
                          ...
                          :selected="formData.purchase_disc_type == $v.formData.$model.purchase_disc_type">
                          <option value=""></option>
                    ...
                    <div class="col-6">
                      <div class="form-group has-float-label">
                        <select class="form-control" name="purchase_disc_amount_type_id"
                          ...
                          :selected="formData.purchase_disc_amount_type == $v.formData.$model.purchase_disc_amount_type">
                          <option value=""></option>
                    ...
                    <div class="col-6">
                      <div class="form-group has-float-label">
                        <select class="form-control" name="sale_disc_type_id" id="sale_disc_type"
                          ...
                          :selected="formData.sale_disc_type == $v.formData.$model.sale_disc_type">
                          <option value=""></option>
                    ...
                    <div class="col-6">
                      <div class="form-group has-float-label">
                        <select class="form-control" name="sale_disc_amount_type_id" id="sale_disc_amount_type"
                          ...
                          :selected="formData.sale_disc_amount_type == $v.formData.$model.sale_disc_amount_type">
                          <option value=""></option>
...
import accounts from "./edit-accounts.vue";
export default {
  ...
  methods: {
    ...
    getStockAccountId(stock_account_id)
    {
      ...
      console.log(this.formData.stock_account_id)
    },
//
    async getCategory() {
      const getCategory = await this.$store.dispatch("getCategory", {
        Id: this.$route.params.id,
      });
      this.formData = getCategory.data.data;
    },
    ...
    async updateCategory() {
      ...
      if (this.$v.$invalid) {
        ...
        try {
          ...
          await this.$store.dispatch("updateCategories", params);
        } catch (errors) {
