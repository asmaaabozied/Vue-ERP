<template>
  <div>
    <top-bar-card
      :listUrlName="`add-productTabulation`"
      :newUrlName="`add-productTabulation`"
      :mainModuel="`tools`"
      :MainCategory="`cards`"
      :pageName="`add-productTabulation`"
      :operation="`list`"
      :delete_action="`deleteProductTabulation`"
...
export default {
  ...
  computed: {
    ...
    productTabulations() {
      this.rows = this.$store.getters.getProductTabulations.data;
      return this.$store.getters.getProductTabulations;
    },
    visibleFields() {
  ...
  methods: {
    ...
    async getResults() {
      console.log('ahmed');
      await this.$store.dispatch("fetchProductTabulations");
      this.rows = this.$store.getters.getProductTabulations.data;
    },
    ...
    async Delete() {
      ...
      if (result.value) {
        await this.$store.dispatch("deleteProductTabulation", params);
