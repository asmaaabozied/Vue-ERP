  ...
  <div>
    ...
    >
      ...
      <div class="card-header flex-wrap border-0 pb-0 d-block">
        ...
        <form @submit.prevent="newCurrency" id="Currency">
...
export default {
  ...
  methods: {
    ...
    async checkDisabled() {
      console.log('disaabledaddinput')
      this.$refs["add-button"].disabled = true;

    },
    async newCurrency() {
      console.log('dataformssss')
      console.log(this.$v)
      ...
      if (this.$v.$invalid) {
        ...
        try {
          ...
          await this.$store.dispatch("storeCurrencies", {
            data: this.formData,
          });
        } catch (errors) {
    ...
    async getCode() {
      const code = await this.$store.dispatch("getCurrenciesCode");
