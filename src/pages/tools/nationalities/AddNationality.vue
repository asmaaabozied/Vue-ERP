  ...
  <div>
    ...
    >
      ...
      <div class="card-header flex-wrap border-0 pb-0 d-block">
        <form @submit.prevent="newNationality" id="nationality">
...
export default {
  ...
  methods: {
    async newNationality() {
      ...
      if (this.$v.$invalid) {
        ...
        try {
          ...
          await this.$store.dispatch("storeNationality", {
            data: this.formData,
          });
        } catch (errors) {
    ...
    async getCode() {
      const code = await this.$store.dispatch("getNationalityCode");
